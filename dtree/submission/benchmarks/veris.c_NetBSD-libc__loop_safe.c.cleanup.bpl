...
function {:existential true} b0(pathbuf: int, pathlim:int, tmp: int): bool;
...
procedure $static_init();
  modifies $M.0, $M.1, alloc, $CurrAddr;
...
implementation __VERIFIER_assert(cond: int)
{
  ...
  $bb0:
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 1} true;
    assume true;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 2} true;
    $b := cond != 0;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 2} true;
    goto $bb3, $bb4;

  $bb1:
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 5} true;
    return;
  ...
  $bb5:
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 3} true;
    goto $bb5;
}



procedure glob2(pathbuf: int, pathlim: int) returns ($r: int);
  modifies $M.0, $M.1, alloc, $CurrAddr;
...
implementation main() returns ($r: int)
{
  ...
  $bb0:
    ...
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 27} true;
    assume true;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 29} true;
    $p1 := $pa($pa($p, 0, 8), 0, 4);
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 29} true;
    $p2 := $pa($p1, 2, 4);
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 29} true;
    ...
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 29} true;
    assume true;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 31} true;
    $p4 := $pa($pa($p, 0, 8), 0, 4);
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 31} true;
    $p5 := $pa($p4, 2, 4);
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 31} true;
    ...
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 31} true;
    $M.0[tmp] := $p6;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 33} true;
    $p7 := $pa($pa($p, 0, 8), 0, 4);
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 33} true;
  ...
  s$bb0:
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 12} true;
    assume true;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 12} true;
    assume true;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 16} true;
    assume true;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 16} true;
    s$p := pathbuf;
    goto s$bb1;
  ...
  s$bb2:
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 18} true;
    s$p1 := $M.0[tmp];
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 18} true;
    s$b2 := $ule(s$p, s$p1);
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 18} true;
    ...
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 18} true;
    assert s$p3 == 1;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 19} true;
    $M.1[s$p] := 1;
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 20} true;
    goto s$bb6;

  s$bb3:
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 22} true;
    $p8 := 0;
    goto exit;
  ...
  exit:
    ...
    assert {:sourcefile "veris.c_NetBSD-libc__loop_safe.c"} {:sourceline 35} true;
    $r := 0;
    return;
}
